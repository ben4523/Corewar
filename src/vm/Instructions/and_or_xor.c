...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/12/21 15:44:07 by unli-yaw          #+#    #+#             */
/*   Updated: 2017/12/21 15:44:11 by unli-yaw         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <corewar.h>

void	apply_and(t_data *data, t_listb *elem, unsigned int *params,
...
void	apply_or(t_data *data, t_listb *elem, unsigned int *params,
			unsigned int *param_type)
{
	int value_one;
	int value_two;
...
void	apply_xor(t_data *data, t_listb *elem, unsigned int *params,
			unsigned int *param_type)
{
	int	value_one;
	int	value_two;
