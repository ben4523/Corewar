...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/12/21 15:44:33 by unli-yaw          #+#    #+#             */
/*   Updated: 2017/12/21 15:44:35 by unli-yaw         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <corewar.h>

void	instr_no_ocp(t_data *data, t_listb *elem, unsigned int *params)
{
...
void	instr_w_ocp(t_data *data, t_listb *elem, unsigned int *params,
